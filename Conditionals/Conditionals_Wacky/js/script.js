...
console.log("You are currently " + plusOrMinus + scoreDifference + " with a score of " + playerScore + ".");//Outputs the players current standing compared to par and their current score
